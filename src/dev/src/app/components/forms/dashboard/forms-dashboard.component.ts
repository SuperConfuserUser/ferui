  ...
  template: ` <div class="container-fluid">
    <div class="row" style="max-width: 1200px">
      <div class="col col-12">
        ...
        <p>
          We've created a set of directives to help manage forms with minimal effort. The structure is more condensed and easier
          to implement, so it is the recommended approach to use the following if you are using Angular.
        </p>
        ...
        <p>
          ...
          validator name provided in the binding for <code>*fuiIfError="'errorName'"</code>, which might be your custom validator
          or a built in Angular one.
        </p>
        <pre><code [highlight]="multipleErrorMsgExample"></code></pre>

        <h5>Default error messages</h5>
        <p>
          Even if we recommend adding an error message for each validator you specify, we already have some defaults ones that you
          can rely on. We support all
          <a href="https://angular.io/api/forms/Validators" target="_blank">angular built-in validators</a> and some other custom
          ones that we've made (Ip-address validator...etc)
        </p>
