        ...
        <div class="container-fluid">
          <div class="row" style="max-width: 1200px">
            <div class="col col-12">
              ...
              <p>
                <b>Note</b> that if you want to add a <code>searchDebounce</code> (waiting some time before triggering the search
                event) you should use the <code>(searchChange)="onModelChange($event)"</code> function on the search container
                instead of <code>(ngModelChange)="onModelChange($event)"</code> because this event takes the debounce time into
                account where the default angular one doesn't.
              </p>

              <h5 class="mt-2 mb-2">
                If you want to display the results directly through this component, you would need to add extra configurations and
                you must use the search container to wrap your search input:
              </h5>
              ...
              <p>
                ...
                <code>FuiFilterComparatorService</code> to apply filter selections to the results. More details on how to use this
                service with custom filters <a [routerLink] [fragment]="'filterComparatorService'">below</a>.
              </p>
              ...
              <p>
                Like mentioned above, you can use your own result template to render your results. To do so, you need to create a
                <code>TemplateRef&lt;FuiSearchResultsContext&lt;T&gt;&gt;</code> element and pass it in the
              ...
              <p>
                ...
                <code>&lt;ng-template&gt;&lt;/ng-template&gt;</code> has some special context variables. You'll have access to the
                <code>resultsObject</code> variable and <code>updateSearchHighlight</code> function. The first one will only
              ...
              <p>
                By default, we are triggering the highlight feature, and loop over only the <b>results container</b> elements, but
                in some cases, you may want to trigger the highlight feature manually (for fuiDatagrid result container for
              ...
              <p>
                ...
                <code>[searchResultsWrapperId]</code> is generated automatically, but if you're doing extra formatting to display
                your results you might want that the highlight feature takes only a specific portion of the results container to
              ...
              <table class="fui-table mb-4">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>number</td>
                    <td>
                      <b>[Optional]</b> Value in milliseconds. If set, the component will wait for <code>[searchDebounce]</code>ms
                      before triggering the search.<br />
                      By default, it is set to <b>null</b> for regular search but it is set to <b>150ms</b> by default if you set
                      <code>[datasource]</code> to a <b>FuiSearchDatasource</b> object.
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>string</td>
                    <td>
                      <b>[Optional]</b> If you want to use a specific container ID for the highlight feature to look for searched
                      words to highlight. This is useful if you want to focus only a certain portion of your results template.<br />
                      <b
                        >Only if <code>[datasource]</code> is set to a valid <b>FuiSearchDatasource</b> object, otherwise this is
                        ignored.</b
                      >
              ...
              <h4 class="mt-3 mb-3">
                ...
                <a [routerLink] [fragment]="'FuiFilterGetDataInterface'" class="anchor-link" id="FuiFilterGetDataInterface">#</a>
              </h4>
              ...
              <p>
                ...
                <code>&lt;fui-filter&gt;&lt;/fui-filter&gt;</code> tag with extra configuration to see the filters button appear.
                Here is a full example on what it looks like:
              </p>
              ...
              <p>
                Here, if we do a search over this object list with the default search input, in our API, we are actually checking
                if the filter passes for every fields (7 fields in total) and see if the typed string matches the field. But
                thanks to <code>FuiFilter</code> component, you can now specify on which field you'll do your search and you can
                also filter out the data by using more in-depth filtering.<br />Try by yourself, type "<b><i>sand</i></b
              ...
              <p>
                ...
                filtering data properly. Create a new class that extends the <code>FuiFilterComparatorService</code>. Remember to
                provide it as needed. Use the new class to override any of the base methods. The
          ...
          <form fuiForm #demoForm="ngForm">
            <demo-page [filtersDisplayed]="true" pageTitle="Input component">
              <p class="mt-5 mb-5 alert alert-primary" role="alert">
                <b>NOTE</b>: Please open your browser console in order to see the events triggered by the search component. This
                is for demonstration purposes, it is on you to do whatever you want with those events.
              </p>
