...
@Component({
  selector: 'virtual-scroller-example',
  template: `
    <div class="container-fluid">
      <div class="row" style="max-width: 1200px">
        <div class="col-12">
          ...
          <h2>Overview</h2>
          <p>
            We've forked <a href="https://github.com/rintoj/ngx-virtual-scroller" target="_blank">ngx-virtual-scoller</a> and
          ...
          <p class="has-line-data">
            Virtual Scroll displays a virtual, “infinite” list. Supports horizontal/vertical, variable heights, &amp;
            multi-column.
          </p>
          <h2 class="code-line">About</h2>
          <p class="has-line-data">
            This module displays a small subset of records just enough to fill the viewport and uses the same DOM elements as the
            user scrolls.<br />
            This method is effective because the number of DOM elements are always constant and tiny irrespective of the size of
            the list. Thus virtual scroll can display an infinitely growing list of items in an efficient way.
          </p>
          <ul>
          ...
          <table class="fui-table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>number</td>
                <td>
                  How often in milliseconds to check if virtual-scroller (or parentScroll) has been resized. If resized, it’ll
                  call Refresh() method. Defaults to 1000.
                </td>
              </tr>
              <tr>
                ...
                <td>number</td>
                <td>
                  How many pixels to ignore during resize check if virtual-scroller (or parentScroll) are only resized by a very
                  small amount. Defaults to 5.
                </td>
              </tr>
              <tr>
                ...
                <td>boolean</td>
                <td>
                  If you want to use the “unequal size” children feature. This is not perfect, but hopefully “close-enough” for
                  most situations. Defaults to false.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>boolean</td>
                <td>
                  Defaults to false. Translate is faster in many scenarios because it can use GPU acceleration, but it can be
                  slower if your scroll container or child elements don’t use any transitions or opacity. More importantly,
                  translate creates a new “containing block” which breaks position:fixed because it’ll be relative to the
                  transform rather than the window. If you’re experiencing issues with position:fixed on your child elements, turn
                  this flag on.
                </td>
              </tr>
              <tr>
                ...
                <td>boolean</td>
                <td>
                  Defaults to true. Set to false if you want to prevent ngx-virtual-scroller from automatically changing the
                  overflow style setting of the parentScroll element to ‘scroll’.
                </td>
              </tr>
              <tr>
                ...
                <td>number</td>
                <td>
                  If you want to override the auto-calculated scrollbar width. This is used to determine the dimensions of the
                  viewable area when calculating the number of items to render.
                </td>
              </tr>
              <tr>
                ...
                <td>number</td>
                <td>
                  If you want to override the auto-calculated scrollbar height. This is used to determine the dimensions of the
                  viewable area when calculating the number of items to render.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>any[]</td>
                <td>
                  The data that builds the templates within the virtual scroll. This is the same data that you’d pass to ngFor.
                  It’s important to note that when this data has changed, then the entire virtual scroll is refreshed.
                </td>
              </tr>
              <tr>
                <td>stripedTable</td>
                <td>boolean</td>
                <td>
                  Defaults to false. Set to true if you use a striped table. In this case, the rows will be added/removed two by
                  two to keep the strips consistent.
                </td>
              </tr>
              <tr>
                <td>bufferAmount</td>
              ...
              <tr>
                ...
                <td>number</td>
                <td>
                  The time in milliseconds for the scroll animation to run for. Default value is 750. 0 will completely disable
                  the tween/animation.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>Function</td>
                <td>
                  Predicate of syntax (item1:any, item2:any)=&gt;boolean which is used when items array is modified to determine
                  which items have been changed (determines if cached child size measurements need to be refreshed or not for
              ...
              <tr>
                ...
                <td>Event&lt;IPageInfo&gt;</td>
                <td>
                  This event is fired every time the <code>start</code> or <code>end</code> indexes or scroll position change and
                  emits <code>IPageInfo</code>.
                </td>
              </tr>
              <tr>
                <td>vsUpdate</td>
                <td>Event&lt;any[]&gt;</td>
                <td>
                  This event is fired every time the <code>start</code> or <code>end</code> indexes change and emits the list of
                  items which should be visible based on the current scroll position from <code>start</code> to <code>end</code>.
                  The list emitted by this event must be used with <code>*ngFor</code> to render the actual list of items within
              ...
              <tr>
                ...
                <td>()=&gt;void</td>
                <td>
                  Function to force re-measuring <em>all</em> cached item sizes. If enableUnequalChildrenSizes===false, only 1
                  item will be re-measured.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>scrollInto</td>
                <td>
                  (item:any, alignToBeginning:boolean = true, additionalOffset:number = 0, animationMilliseconds:number =
                  undefined, animationCompletedCallback:()=&gt;void = undefined)=&gt;void
                </td>
              ...
              <tr>
                <td>scrollToIndex</td>
                <td>
                  (index:number, alignToBeginning:boolean = true, additionalOffset:number = 0, animationMilliseconds:number =
                  undefined, animationCompletedCallback:()=&gt;void = undefined)=&gt;void
                </td>
              ...
              <tr>
                ...
                <td>number</td>
                <td>
                  The hard-coded height of the item template’s cell to use if rendering via Angular
          ...
          <p class="has-line-data">
            If the parentScroll is a custom angular component (instead of a native HTML element such as DIV), Angular will wrap
            the #scrollingBlock variable in an ElementRef
            <a href="https://angular.io/api/core/ElementRef">https://angular.io/api/core/ElementRef</a> in which case you’ll need
            to use the .nativeElement property to get to the underlying javascript DOM element reference.
          </p>
          ...
          <p class="has-line-data">
            Items must have fixed height and width for this module to work perfectly. If not, set
          ...
          <p class="has-line-data">
            Note: The #header angular selector will make the &lt;thead&gt; element fixed to top. If you want the header to scroll
            out of view don’t add the #header angular element ref.
          </p>
          ...
          <p class="has-line-data">
            virtual-scroller caches the measurements for the rendered items. If enableUnequalChildrenSizes===true then each item
            is measured and cached separately. Otherwise, the 1st measured item is used for all items.<br />
            If your items can change sizes dynamically, you’ll need to notify virtual-scroller to re-measure them. There are 3
          ...
          <h2 class="code-line">
            <a id="If_child_view_state_is_reverted_after_scrolling_away__back_335"></a>If child view state is reverted after
            scrolling away &amp; back
          </h2>
          <p class="has-line-data">
            virtual-scroller essentially uses *ngIf to remove items that are scrolled out of view. This is what gives the
            performance benefits compared to keeping all the off-screen items in the DOM.
          </p>
          <p class="has-line-data">
            Because of the *ngIf, Angular completely forgets any view state. If your component has the ability to change state,
            it’s your app’s responsibility to retain that viewstate in your own object which data-binds to the component.
          </p>
          <p class="has-line-data">
            For example, if your child component can expand/collapse via a button, most likely scrolling away &amp; back will
            cause the expansion state to revert to the default state.
          </p>
          <p class="has-line-data">
            To fix this, you’ll need to store any “view” state properties in a variable &amp; data-bind to it so that it can be
            restored when it gets removed/re-added from the DOM.
          </p>
          ...
          <p class="has-line-data">
            ...
            This was implemented using the setInterval method which may cause minor performance issues. It shouldn’t be
            noticeable, but can be disabled via [checkResizeInterval]=“0”<br />
          ...
          <p class="has-line-data">
            You can use the
            <code
              >scrollInto(item, alignToBeginning?, additionalOffset?, animationMilliseconds?, animationCompletedCallback?)</code
            >
            api to scroll into an item in the list.<br />
            You can also use the
            <code
              >scrollToIndex(index, alignToBeginning?, additionalOffset?, animationMilliseconds?,
              animationCompletedCallback?)</code
            >
          ...
          <p class="has-line-data">
            Always be sure to send an immutable copy of items to virtual scroll to avoid unintended behavior. You need to be
            careful when doing non-immutable operations such as sorting:
          </p>
          ...
          <p class="has-line-data">
            If you want to nest additional elements inside virtual scroll besides the list itself (e.g. search field), you need to
            wrap those elements in a tag with an angular selector name of #container.
          </p>
          ...
          <p class="has-line-data">
            virtual-scroller uses *ngFor to render the visible items. When an *ngFor array changes, Angular uses a trackBy
            function to determine if it should re-use or re-generate each component in the loop.<br />
            ...
            If the array used by *ngFor is of type number[] or string[], Angular’s default trackBy function will work
            automatically, you don’t need to do anything extra.<br />
          ...
          <p class="has-line-data">
            virtual-scroller is coded to be extremely fast. If scrolling is slow in your app, the issue is with your custom
            component code, not with virtual-scroller itself.<br />
            Below is an explanation of how to correct your code. This will make your entire app much faster, including
            virtual-scroller.
          </p>
          <p class="has-line-data">
            Each component in Angular by default uses the ChangeDetectionStrategy.Default “CheckAlways” strategy. This means that
            Change Detection cycles will be running constantly which will check <em>EVERY</em> data-binding expression on
          ...
          <p class="has-line-data">
            If virtual-scroller feels slow, a possible quick solution that masks the real problem is to use scrollThrottlingTime
            or scrollDebounceTime APIs.
          </p>
          <p class="has-line-data">
            The correct fix is to make cycles as fast as possible and to avoid unnecessary ChangeDetection cycles. Cycles will be
            faster if you avoid complex logic in data-bindings. You can avoid unnecessary Cycles by converting your components to
            use ChangeDetectionStrategy.OnPush.
          </p>
          <p class="has-line-data">
            ChangeDetectionStrategy.OnPush means the consuming app is taking full responsibility for telling Angular when to run
            change detection rather than allowing Angular to figure it out itself. For example, virtual-scroller has a bound
            property [items]=“myItems”. If you use OnPush, you have to tell Angular when you change the myItems array, because it
            won’t determine this automatically.<br />
            OnPush is much harder for the programmer to code. You have to code things differently: This means 1) avoid mutating
            state on any bound properties where possible &amp; 2) manually running change detection when you do mutate state.<br />
            OnPush can be done on a component-by-component basis, however I recommend doing it for <em>EVERY</em> component in
            your app.
          </p>
          <p class="has-line-data">
            If your biggest priority is making virtual-scroller faster, the best candidates for OnPush will be all custom
            components being used as children underneath virtual-scroller. If you have a hierarchy of multiple custom components
          ...
          <p class="has-line-data">
            ...
            MyEntryLevelAppComponent &amp; SomeRandomComponentWhichUsesOnPush are examples that you’ll need to modify for your
            specific app. If you follow this pattern, OnPush is much easier to implement. However, the really hard part is
            analyzing all of your code to determine <em>where</em> you’re mutating state. Unfortunately there’s no magic bullet
            for this, you’ll need to spend a lot of time reading/debugging/testing your code.
          </p>
          <h2 class="code-line">
          ...
          <p class="has-line-data">
            These APIs are meant as a quick band-aid fix for performance issues. Please read the other performance sections above
            to learn the correct way to fix performance issues.
          </p>
          <p class="has-line-data">
            Without these set, virtual-scroller will refresh immediately whenever the user scrolls.<br />
            Throttle will delay refreshing until # milliseconds after scroll started. As the user continues to scroll, it will
            wait the same # milliseconds in between each successive refresh. Even if the user stops scrolling, it will still wait
            the allocated time before the final refresh.<br />
            ...
            Note: If virtual-scroller hasn’t refreshed &amp; the user has scrolled past bufferAmount, no child items will be
            rendered and virtual-scroller will appear blank. This may feel confusing to the user. You may want to have a spinner
            or loading message display when this occurs.
          </p>
          <h2 class="code-line">
            <a id="Angular_Universal__ServerSide_Rendering_646"></a>Angular Universal / Server-Side Rendering
          </h2>
          <p class="has-line-data">
            The initial SSR render isn’t a fully functioning site, it’s essentially an HTML “screenshot” (HTML/CSS, but no JS).
            However, it immediately swaps out your “screenshot” with the real site as soon as the full app has downloaded in the
            background. The intent of SSR is to give a correct visual very quickly, because a full angular app could take a long
            time to download. This makes the user <em>think</em> your site is fast, because hopefully they won’t click on anything
            that requires JS before the fully-functioning site has finished loading in the background. Also, it allows screen
            scrapers without javascript to work correctly (example: Facebook posts/etc).<br />
            virtual-scroller relies on javascript APIs to measure the size of child elements and the scrollable area of their
            parent. These APIs do not work in SSR because the HTML/CSS “screenshot” is generated on the server via Node, it
            doesn’t execute/render the site as a browser would. This means virtual-scroller will see all measurements as undefined
            and the “screenshot” will not be generated correctly. Most likely, only 1 child element will appear in your
            virtual-scroller. This “screenshot” can be fixed with polyfills. However, when the browser renders the “screenshot”,
            the scrolling behaviour still won’t work until the full app has loaded.
          </p>
          <p class="has-line-data">
            SSR is an advanced (and complex) topic that can’t be fully addressed here. Please research this on your own. However,
            here are some suggestions:
          </p>
          <ol>
            <li class="has-line-data">
              Use <a href="https://www.npmjs.com/package/domino">https://www.npmjs.com/package/domino</a> and
              <a href="https://www.npmjs.com/package/raf">https://www.npmjs.com/package/raf</a> polyfills in your main.server.ts
              file
            </li>
          </ol>
          ...
          <ol start="2">
            <li class="has-line-data">
              Determine a default screen size you want to use for the SSR “screenshot” calculations (suggestion: 1920x1080). This
              won’t be accurate for all users, but will hopefully be close enough. Once the full Angular app loads in the
              background, their real device screensize will take over.
            </li>
            <li class="has-line-data">
              Run your app in a real browser without SSR and determine the average width/height of the child elements inside
              virtual-scroller as well as the width/height of the virtual-scroller (or [parentScroll] element). Use these values
              to set the [ssrChildWidth]/[ssrChildHeight]/[ssrViewportWidth]/[ssrViewportHeight] properties.
            </li>
          </ol>
